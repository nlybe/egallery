...
return [
    ...
    'collection:object:gallery_item' => 'Photos',
    ...
    'egallery:item:add:title:help' => "Set the title of the photo",
    'egallery:item:add:url' => "Image Source (url)",
    'egallery:item:add:url:help' => "Optionally set a url of photo source",
    ...
    'egallery:item:url' => "Photo Source", 
    ...
    'egallery:settings:photos:intro' => 'Select entities for which to allow attaching photos.',
